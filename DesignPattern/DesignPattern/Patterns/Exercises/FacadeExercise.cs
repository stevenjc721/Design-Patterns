 ...
 * Below is a complex system that builds magic squares.
 * 
 * Generator: makes an array of random digits of a particular length. You can use this generator several times to build a square matrix of required size
 * 
