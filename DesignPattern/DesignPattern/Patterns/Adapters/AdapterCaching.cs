...
namespace DesignPattern.Patterns.Adapters
{
    class AdapterCaching
    {
        ...
        //Keeps cache now so you don't regenerate previously generated 
        public class LineToPointAdapter : IEnumerable<Point>
        {
            ...
            public LineToPointAdapter(Line line)
            {
                ...
                Console.Out.WriteLine($"{++count}:  Generating points for line [{line.Start.X}, {line.Start.Y}] - [{line.End.X},{line.End.Y}]");
